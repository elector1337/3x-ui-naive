...
func NewAPIController(g *gin.RouterGroup, naive *service.NaiveService) *APIController {
	a := &APIController{}
	a.initRouter(g, naive)
	return a
}
...
func (a *APIController) initRouter(g *gin.RouterGroup, naive *service.NaiveService) {
	// Main API group
