...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary:
          'Create a new naive server. Cross-checks port against existing xray inbounds and other naive servers. Encrypts authPass at rest.',
      ...
      },
      {
        ...
        summary:
          'Tail the per-server log file. Reads only the last 256 KiB of disk and returns up to N lines.',
        params: [
          { name: 'id', in: 'path', type: 'number', desc: 'Server ID.' },
          {
            ...
            in: 'query',
            type: 'number',
            desc: 'Number of trailing lines, default 200, max 1000.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        summary:
          'Where the panel found a usable Caddy binary, its version, and whether Go is available for building.',
        response:
      ...
      },
      {
        ...
        summary:
          'Build a Caddy binary with the forward_proxy plugin via xcaddy. Streams progress as Server-Sent Events.',
      },
      {
        method: 'POST',
      ...
      },
      {
        ...
        summary:
          'Validate a Caddyfile via caddy adapt. Returns ok or a parser error with line number.',
