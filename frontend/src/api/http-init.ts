...
// Unbuffered POST (with CSRF + base path) for streaming endpoints such as SSE;
// the caller consumes res.body itself.
export function postRaw(url: string, data?: unknown): Promise<Response> {
  return performFetch('POST', url, data, {});
}
